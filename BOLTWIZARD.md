...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 96" width="440" height="192" role="img" aria-label="BoltWizard — animated hero">
  ...
  <!-- Subtle background ripple (subtle, not distracting). -->
...
# The autonomous watcher (lint + test on every save)
npm run watch
...
If you have suggestions or find a bug, please open an issue on the project repository.
...
<sub>Linked from the in-app footer (`#/terms`) and superseded by the markdown rendering on GitHub for full context. Plain-English summary follows; the in-app route is the operative one for users.</sub>
...
<sub>Linked from the in-app footer (`#/privacy`). Plain-English summary follows; the in-app route is the operative one for users.</sub>
